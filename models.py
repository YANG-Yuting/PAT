...
class BERT(BaseModel):
    ...
    def __init__(self, args):
        ...
        self.model = BertForSequenceClassification.from_pretrained(args.target_model_path, num_labels=args.nclasses).cuda()
...
class BERT_snli(BaseModel):
    ...
    def __init__(self, args):
        ...
        self.decoder = nn.Linear(self.hidden_size, args.nclasses)
