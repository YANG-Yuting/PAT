...
parser.add_argument("--code_path", type=str, default="/pub/data/huangpei/WordRobust/", help="path of code/project")
parser.add_argument("--save_path", type=str, default="/pub/data/huangpei/PAT-AAAI23/TextFooler/", help="path of saved code/project")
...
if args.task == 'imdb':
    ...
    # with open(args.data_path + '%s/dataset_%d_new.pkl' % (args.task, args.max_vocab_size), 'rb') as f: # textfooler攻击时使用_new的
